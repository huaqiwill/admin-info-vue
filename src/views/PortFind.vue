    ...
    <div class="home" style="margin: 20px">
      <el-form inline="true" size="small">
        <el-form-item label="生物名称">
          <el-input v-model="search1" placeholder="请输入港口名称" clearable>
            <template #prefix>
        ...
        <el-form-item label="生物门属">
          <el-input v-model="search2" placeholder="请输入国家名称" clearable>
            <template #prefix>
              <el-icon class="el-input__icon">
                <search />
              </el-icon>
        ...
        <el-form-item label="生物危害">
          <el-input v-model="search3" placeholder="请输入省份名称" clearable>
            <template #prefix>
              <el-icon class="el-input__icon">
                <search />
              </el-icon>
      ...
      >
        ...
        <el-table-column prop="biology_num" label="生物编号" sortable />
        <el-table-column prop="biology_name" label="生物名称" />
        <el-table-column prop="biology_belong_to" label="生物门属" sortable />
        <el-table-column prop="port_name" label="港口名称" />
        <el-table-column prop="first_found_time" label="首次发现时间" />
        <el-table-column prop="first_found_location" label="首次发现地点" />
        ...
        <el-table-column fixed="right" label="操作">
          <template v-slot="scope">
            ...
            <el-popconfirm
              title="确认还书?"
              @confirm="
                handlereturn(scope.row.id, scope.row.isbn, scope.row.borrownum)
              "
              v-if="user.role == 2"
      ...
      <el-dialog v-model="dialogVisible2" title="修改书籍信息" width="30%">
        <el-form :model="form" label-width="120px">
          <el-form-item label="图书编号">
            <el-input style="width: 80%" v-model="form.nNum"></el-input>
          </el-form-item>
          <el-form-item label="图书名称">
            <el-input style="width: 80%" v-model="form.pName"></el-input>
          </el-form-item>
          <el-form-item label="价格">
            <el-input style="width: 80%" v-model="form.nName"></el-input>
          </el-form-item>
          <el-form-item label="作者">
            <el-input style="width: 80%" v-model="form.pShengFen"></el-input>
          </el-form-item>
        </el-form>
